...
% 4. Execute the agent using: execute_agent(myagent,(localhost,33333),a_static_agent_handler). NOTE:the port is same as that of Static Agent and NOT that of Tartarus. This is differnt in the case of mobile agents.
% 5. That's all!
