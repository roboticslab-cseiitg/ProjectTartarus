...
:-dynamic verbose1/1.
:-dynamic in_hop_times_agents/1.
:-dynamic out_hop_times_agents/1.
:-dynamic length1/1. 
...
handler(platform,(Ip,Port),send_ackm(GUID,_X)):- 
       ...
       (Il2=:=1,                                                            
        ...
        out_hop_times_agents(L81),      
        %(member(L82,L81)->delete_list(L83,L81,NewList100),add_tail(NewList100,L88,New100),retractall(out_hop_times_agents(_)),assert(out_hop_times_agents(New100));add_tail(L81,L88,New100),retractall(out_hop_times_agents(_)),assert(out_hop_times_agents(New100))),
        add_tail(L81,L88,New100),retractall(out_hop_times_agents(_)),assert(out_hop_times_agents(New100)),
...
overall_avg:-
      ...
      retractall(avg_hop_time(_,_,_)), assert(avg_hop_time(OverallMax,OverallMin,OverallAverageHopTime)).
...
predicate_tar1(GUID,Time_taken):- 
         ...
         in_hop_times_agents(K81),      
         %(member(K82,K81)->delete_list(K83,K81,NewList200),add_tail(NewList200,K88,New200),retractall(in_hop_times_agents(_)),assert(in_hop_times_agents(New200));add_tail(K81,K88,New200),retractall(in_hop_times_agents(_)),assert(in_hop_times_agents(New200))),
         add_tail(K81,K88,New200),retractall(in_hop_times_agents(_)),assert(in_hop_times_agents(New200)),
...
hoptime_info3:- 
      out_hop_times_agents(New100),write_list3(New100).
...
hoptime_info2:- 
      in_hop_times_agents(New200),write_list2(New200).
